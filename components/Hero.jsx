  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-linear-to-r from-foreground/90 via-foreground/70 to-transparent" />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl">
          ...
          {/* Headline */}
          <h1
            className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold text-primary-foreground mb-6 leading-tight animate-fade-in"
            style={{ animationDelay: "0.1s" }}
          >
            Plan Unforgettable{" "}
            <span className="text-gradient-accent">School Adventures</span> with
            Ease
          </h1>

          {/* Subheadline */}
          <p
            className="text-lg sm:text-xl text-primary-foreground/80 mb-8 leading-relaxed animate-fade-in"
          ...
          {/* Stats */}
          <div
            className="grid grid-cols-3 gap-6 animate-fade-in"
